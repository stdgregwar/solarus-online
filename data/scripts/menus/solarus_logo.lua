...
local surface = sol.surface.create(201, 48+24)
...
local online = sol.sprite.create'menus/solarus_logo'
online:set_animation'online'

-- Black square below the sun.
local black_square = sol.surface.create(48, 48)
...
function solarus_logo_menu:step3()
  animation_step = 3
  rebuild_surface()
  online:set_animation('online', function()
    online:set_frame(0); online:set_paused();
  --rebuild_surface()
  end)
  function online:on_frame_changed() rebuild_surface() end
  sol.timer.start(solarus_logo_menu, 500, function()
    surface:fade_out()
