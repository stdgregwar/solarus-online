...
function persos_menu:on_started()
...
function persos_menu:on_key_pressed(key)
...
function persos_menu:on_joypad_button_pressed(button)
...
function persos_menu:on_joypad_axis_moved(axis, state)
...
function persos_menu:on_joypad_hat_moved(hat, direction8)
...
function persos_menu:direction_pressed(direction8)
...
function persos_menu:on_draw(dst_surface)
...
function persos_menu:draw_savegame(slot_index)
...
function persos_menu:draw_savegame_cursor()
...
function persos_menu:draw_savegame_number(slot_index)

  local slot = self.slots[slot_index]
  slot.number_img:draw(self.surface, 62, 53 + slot_index * 27)
end

function persos_menu:draw_bottom_buttons()
...
function persos_menu:read_savegames()
...
function persos_menu:set_bottom_buttons(key1, key2)
...
function persos_menu:move_cursor_up()
...
function persos_menu:move_cursor_down()
...
function persos_menu:move_cursor_left_or_right()
...
function persos_menu:set_cursor_position(cursor_position)

  self.cursor_position = cursor_position
  self.cursor_sprite:set_frame(0)  -- Restart the animation.
end

function persos_menu:repeat_move_clouds()
...
-- Phase "select a file" --
---------------------------
function persos_menu:init_phase_select_file()
...
function persos_menu:key_pressed_phase_select_file(key)
...
function persos_menu:joypad_button_pressed_phase_select_file(button)

  return self:key_pressed_phase_select_file("space")
end

function persos_menu:direction_pressed_phase_select_file(direction8)
...
function persos_menu:draw_phase_select_file()
...
-- Phase "erase a file" --
--------------------------
function persos_menu:init_phase_erase_file()
...
function persos_menu:key_pressed_phase_erase_file(key)
...
function persos_menu:joypad_button_pressed_phase_erase_file(button)

  return self:key_pressed_phase_erase_file("space")
end

function persos_menu:direction_pressed_phase_erase_file(direction8)
...
function persos_menu:draw_phase_erase_file()
...
-- Phase "Are you sure?" --
---------------------------
function persos_menu:init_phase_confirm_erase()
...
function persos_menu:key_pressed_phase_confirm_erase(key)
...
function persos_menu:joypad_button_pressed_phase_confirm_erase(button)

  return self:key_pressed_phase_confirm_erase("space")
end

function persos_menu:direction_pressed_phase_confirm_erase(direction8)
...
function persos_menu:draw_phase_confirm_erase()
...
-- Phase "options" --
----------------------
function persos_menu:init_phase_options()
...
function persos_menu:key_pressed_phase_options(key)
...
function persos_menu:joypad_button_pressed_phase_options(button)
  return self:key_pressed_phase_options("space")
end

function persos_menu:direction_pressed_phase_options(direction8)
...
function persos_menu:draw_phase_options()
...
function persos_menu:set_options_cursor_position(position)
...
function persos_menu:set_option_value(option, index)
...
function persos_menu:reload_options_strings()
...
------------------------------
function persos_menu:init_phase_choose_name()
...
function persos_menu:key_pressed_phase_choose_name(key)
...
function persos_menu:joypad_button_pressed_phase_choose_name(button)

  return self:key_pressed_phase_choose_name("space")
end

function persos_menu:direction_pressed_phase_choose_name(direction8)
...
function persos_menu:draw_phase_choose_name()
...
function persos_menu:add_letter_player_name()
...
function persos_menu:validate_player_name()
...
function persos_menu:set_initial_values(savegame)
